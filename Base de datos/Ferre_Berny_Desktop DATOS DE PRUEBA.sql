...
values('DOC-00001', 1, '2021-03-02', 1500, 150)
insert into Compras(Documento, Id_Proveedor, Fecha, Sumas, Iva)
values('DOC-00002', 2, '2021-04-03', 1500, 150)
insert into Compras(Documento, Id_Proveedor, Fecha, Sumas, Iva)
values('DOC-00003', 3, '2021-03-04', 1500, 150)
go

insert into Ventas(Documento, Fecha, Suma) values('VE-00001', '2021-05-05', 3000)
insert into Ventas(Documento, Fecha, Suma) values('VE-00002', '2021-05-06', 2000)
insert into Ventas(Documento, Fecha, Suma) values('VE-00003', '2021-05-07', 1000)
go
...
values(0, 1, 1, 1, 200, 5, 1000, '2021-03-02', 750)
insert into Kardex(Id_Venta, Id_Producto, Id_Compra, Id_almacen, Cantidad, Precio, PrecioTotal, Fecha, CantidadNueva)
values(0, 2, 1, 2, 50, 10, 500, '2021-03-02', 600)
insert into Kardex(Id_Venta, Id_Producto, Id_Compra, Id_almacen, Cantidad, Precio, PrecioTotal, Fecha, CantidadNueva)
values(0, 3, 2, 3, 200, 5, 1000, '2021-04-03', 1100)
insert into Kardex(Id_Venta, Id_Producto, Id_Compra, Id_almacen, Cantidad, Precio, PrecioTotal, Fecha, CantidadNueva)
values(0, 4, 2, 4, 50, 10, 500, '2021-04-03', 600)
insert into Kardex(Id_Venta, Id_Producto, Id_Compra, Id_almacen, Cantidad, Precio, PrecioTotal, Fecha, CantidadNueva)
values(0, 5, 3, 5, 300, 50, 1500, '2021-03-04', 1000)
insert into Kardex(Id_Venta, Id_Producto, Id_Compra, Id_almacen, Cantidad, Precio, PrecioTotal, Fecha, CantidadNueva)
values(1, 3, 0, 3, 600, 5, 3000, '2021-05-05', 500)
insert into Kardex(Id_Venta, Id_Producto, Id_Compra, Id_almacen, Cantidad, Precio, PrecioTotal, Fecha, CantidadNueva)
values(2, 4, 0, 4, 200, 10, 2000, '2021-05-06', 400)
insert into Kardex(Id_Venta, Id_Producto, Id_Compra, Id_almacen, Cantidad, Precio, PrecioTotal, Fecha, CantidadNueva)
values(3, 5, 0, 5, 200, 5, 1000, '2021-05-07', 800)
